...
Antes de começar o desenvolvimento, gere 3 sugestões de estrutura para organização do projeto para eu escolher, sendo uma estrutura mais simples com todos os arquivos na mesma pasta. Lembrando que sera um app mobile!